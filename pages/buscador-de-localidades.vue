      ...
      <div class="container border shadow bg-background">
        <form class="flex flex-col gap-2 p-4">
          <h1 class="font-bold text-4xl galaxy bg-clip-text text-transparent">
            Consulta</h1>
          <small class="text-muted-foreground">PD: Si no funciona, probablemente me banearon de Github por andar
            abusando
            de su API</small>
          <div class="grid gap-2 grid-cols-2">
            ...
            <Select :disabled="!selected_municipio">
              ...
              <SelectContent>
                <SelectItem v-for="localidad in localidades" :value="localidad.nombre">{{
                    localidad.nombre
                  }}
                </SelectItem>
              </SelectContent>
